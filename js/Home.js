    ...
    var buton_show = document.getElementById("buton-show");
    var buton_exit = document.getElementById("buton-exit");
    var img = document.getElementById("image");

    buton_show.addEventListener("click", function () {
      // img.style.opacity = "1";
      img.style.display = 'block';
    });
    buton_exit.addEventListener("click", function () {
      // img.style.opacity = "0";
